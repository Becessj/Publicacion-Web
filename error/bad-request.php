...
<html lang="en">
    ...
    <body oncontextmenu="return false;">
        <div class="wrapper">
            <div class="content">
                <img class="img-responsive" src="<?php echo BASE_URL . '/images/bad-request.png'; ?>" alt="icono" draggable="false" />
                <h2 class="text-primary">Solicitud no válida</h2>
                <p class="text-muted">Su solicitud no pudo ser procesada por presentar malformaciones.</p>
            </div>
        </div>
    </body>
</html>
