...
<html lang="en">
    ...
    <body oncontextmenu="return false;">
        <div class="wrapper">
            <div class="content">
                <img class="img-responsive" src="<?php echo BASE_URL . '/images/forbidden.png'; ?>" alt="icono" draggable="false" />
                <h2 class="text-primary">Acceso denegado</h2>
                <p class="text-muted">No tiene autorización para acceder a este recurso.</p>
            </div>
        </div>
    </body>
</html>
