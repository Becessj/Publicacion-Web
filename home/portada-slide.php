<?php
    ...
    if (!file_exists($file)) {
        ...
        WideImage::load(join_paths(IMAGES_PATH, 'image-slide-placeholder.png'))->output('png');
    }
    else {
        // Muestra la imagen
        WideImage::load($file)->resize(750, 461, 'outside')->crop('center', 'center', 750, 461)->output('jpg', 75);
    }
?>