...
<html lang="es">
    ...
    <head>
        ...
        <title>Panel de control | Iniciar sesión</title>
...
<a href="http://munisansebastian.gob.pe" alt="Municipalidad Distrital de San Sebastian">
        ...
        <div class="container bg-default login-menu">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h3 class="page-header">Módulo de Consulta de Estado de Cuenta - CPanel</h3>
            ...
            <div class="modal-dialog modal-form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn-submit" data-target="#form-solicitar-contrasena">Envair</button>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Copyright &copy; 2017<?php echo intval(date('Y')) <= 2017 ? '' : ' - ' . date('Y'); ?> Jonattan Chuquimia Abal, reservados todos los derechos</p>
